/**
 * File              : OrthographicCameraLayer.cpp
 ...
 */
#include "bepch.h"
#include "OrthographicCameraLayer.h"
...
namespace Engine {
  OrthographicCameraLayer::OrthographicCameraLayer(const std::string& name)
  : m_Camera(-1.6f, 1.6f, -0.9f, 0.9f),
  m_CameraPosition(0.0f, 0.0f, 3.0f)
  {}
  OrthographicCameraLayer::~OrthographicCameraLayer()
  {}

  void OrthographicCameraLayer::OnAttach(){}
  void OrthographicCameraLayer::OnDetach(){}

  void OrthographicCameraLayer::OnUpdate(Timestep ts){
    {
  ...
  void OrthographicCameraLayer::OnEvent(Event& event){}
  void OrthographicCameraLayer::OnImGuiRender(){
    ImGui::Begin("Camera");
